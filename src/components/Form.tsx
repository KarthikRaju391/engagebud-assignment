                ...
                <div className='flex flex-col'>
                    <div className='flex flex-col gap-2 mt-4'>
                        <div className='relative'>
                            ...
                            <input onChange={(e) => setEmail(e.target.value)} className='w-full px-2 pl-12 py-4 outline-none border-b-secondary border-b-2 focus:ring-0 rounded-t-md' type="text" placeholder='Email' />
                        </div>
                        <div className='relative'>
                            ...
                            <input onChange={(e) => setPhone(e.target.value)} className='w-full px-2 pl-12 py-4 outline-none border-b-secondary border-b-2 focus:ring-0 rounded-t-md' type="text" placeholder='Phone number' />
                        </div>
                    </div>
                    <div className='mt-4 border-2 border-black rounded-md flex justify-evenly py-2'>
                        <input required type="checkbox" className='p-3 self-center rounded-sm focus:ring-0 accent-gray-700 bg-black outline-none checked:shadow-md ' />
