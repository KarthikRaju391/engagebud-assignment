                ...
                <div className='flex flex-col'>
                    <div className='flex flex-col gap-2 mt-4'>
                        <div className='relative'>
                            ...
                            <input onChange={(e) => setEmail(e.target.value)} className={`w-full px-2 pl-12 py-4 outline-none ${emailError ? 'border-b-red-600' : 'border-b-secondary'} border-b-2 focus:ring-0 rounded-t-md`} type="text" placeholder='Email' />
                        </div>
                        <div className='relative'>
                            ...
                            <input onChange={(e) => setPhone(e.target.value)} className={`w-full px-2 pl-12 py-4 outline-none ${phoneError ? 'border-b-red-600' : 'border-b-secondary'} border-b-2 focus:ring-0 rounded-t-md`} type="text" placeholder='Phone number' />
                        </div>
                    </div>
